  ...
  <header class="header-alimentos">
    ...
    <div class="zona-superior-derecha">
      ...
      <div class="contenedor-carrito">
        <a href="carrito.html" class="boton-carrito">馃洅 Carrito</a>
      </div>
    </div>
  </header>
  ...
  <div class="contenedor-navegacion">
    <nav class="navegacion-alimentos">
      <ul>
        ...
        <li><a href="lacteos.html">L谩cteos</a></li>
        <li><a href="panaderia.html">Panader铆a</a></li>
        <li><a href="pasteleria.html">Pasteler铆a</a></li>
    ...
    <section class="banner-slider">
      <div class="slide active">
        <img src="imagenes/banner1.jpg.webp" alt="Promoci贸n 1">
      </div>
      <div class="slide">
        <img src="imagenes/banner2.jpg.webp" alt="Promoci贸n 2">
      </div>
      <div class="slide">
        <img src="imagenes/banner3.jpg.webp" alt="Promoci贸n 3">
      </div>
      <div class="slide">
        <img src="imagenes/banner4.jpg.webp" alt="Promoci贸n 4">
      </div>
      <div class="slide">
        <img src="imagenes/banner5.jpg.webp" alt="Promoci贸n 5">
      </div>
      <div class="slide">
        <img src="imagenes/banner6.jpg.webp" alt="Promoci贸n 6">
      </div>
    ...
    <section class="productos-destacados">
      ...
      <div class="lista-productos">
        ...
        <div class="producto">
          <img src="imagenes/pasteleria43.png" alt="Turr贸n de Do帽a Pepa 500g">
          <h3>Turr贸n de Do帽a Pepa 500g</h3>
        ...
        <div class="producto">
          ...
          <h3>Red Bull sin az煤car 250 mL</h3>
          <p class="precio">S/ 7.90 / UN</p>
          <button class="boton-comprar">Agregar al carrito</button>
        </div>
        <div class="producto">
          <img src="imagenes/abarrote47.png" alt="S贸lido de At煤n en Aceite 140g">
          <h3>S贸lido de At煤n en Aceite 140g</h3>
